...
KC_NO   ,  OSM_CTL ,  OSM_GUI ,  OSM_ALT ,  NUM_SPC ,  MOV_ENT ,  KC_RALT ,  KC_RGUI ,  KC_RCTL ,   MO(_ADJUST)  \
),
...
*/
 ...
 [_ADJUST] =LAYOUT( \
  SCRE_UP ,  QWERTY  ,  COLEMAK , UC(STAR) ,   KC_NO  ,   KC_NO  ,   KC_NO  ,   KC_NO  ,   KC_NO  , KC_VOLU  ,   KC_NO  ,  RESET ,\
